...
############# DL section #############
    ...
    if choix_page_dl == "Transfert de style neuronal":
        ...
        with c1:
            image_mode = st.select(options=["Image locale", "Selectionner parmi vos images"], default="Image locale", label="")
        if image_mode == "Selectionner parmi vos images":
            ...
            with c2 :
                choix_photo_to_detect = st.select(options=["Plage", "New-York", "Chiens"],label="")
